export const keybindList = [
  [
    ...
    },
    {
      ...
      binds: [
        ...
        {
          keys: ["󰖳", "Shift", "+", "←↑→↓"],
          action: "Swap window in direction",
        },
  ...
  [
    ...
    },
    {
      ...
      name: "Utilities",
      binds: [
        { keys: ["󰖳", "Ctrl", "L"], action: "Lock screen" },
        { keys: ["󰖳", "Alt", "L"], action: "Suspend" },
        { keys: ["PrtSc"], action: "Screenshot selection >>  clipboard" },
        { keys: ["Ctrl", "PrtSc"], action: "Screenshot  Full screen" },
        { keys: ["󰖳", "PrtSc"], action: "Record Screen" },
        {
          keys: ["󰖳", "+", "B"],
  ...
  [
    {
      ...
      binds: [
        ...
        { keys: ["󰖳", "+", "O"], action: "Launch Obsidian" },
      ],
      id: 6,
    },
    {
